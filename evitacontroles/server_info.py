...
Esta clase obtiene información de las librerias disponibles en python y crea una
pagina html para mostrar esta información, es un concepto similar a la función
phpinfo(); de PHP y está basado en el codigo de Bran van der Meer (branneman)

mas info: https://gist.github.com/branneman/951825#file-pyinfo-py
...
def pyinfo():
    ...
    output =   '<div id="server-info" class="center">'
...
def section_database():
    ...
    data += 'MySQL (MySQL-Python)',       imported('_mysql')
